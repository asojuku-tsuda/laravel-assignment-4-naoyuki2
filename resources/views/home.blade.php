...
<body>
    <div class="container">
        ...
        <div class="exercise-section">
            ...
            <a href="{{ route('user.show', ['id' => 123]) }}" class="btn btn-primary">ユーザーID:123のページへ</a>
            <div class="uri-display">
        ...
        <div class="exercise-section">
            ...
            <a href="{{ route('product.show', ['category' => 'electronics', 'id' => 456]) }}" class="btn btn-primary">電子機器カテゴリー、商品ID:456のページへ</a>
            <div class="uri-display">
